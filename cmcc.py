...
data = 'wlanuserip=%s&wlanacname=%s&wlanacip=%s&wlanacssid=CMCC&staticusername=%s&staticpassword=%s&loginmode=static' % (userip, acname, acip,username,passwd)
#url = os.path.join(os.path.dirname(test.url), data)
url = 'https://221.176.1.140/do_login.php'
